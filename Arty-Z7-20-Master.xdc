...
#create_clock -add -name sys_clk_pin -period 1000000000.00 -waveform {0 4} [get_ports { SYS_clk }];#set
...
set_property -dict { PACKAGE_PIN M15    IOSTANDARD LVCMOS33 } [get_ports { led_clk }]; #IO_L23N_T3_35 Sch=LED5_R
...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets EX/alu1/MEM_instruction_reg[29][2]]
